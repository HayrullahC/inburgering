...
export const GRAMMAR = [
  ...
  },
  {
    ...
    body: [
      { en: 'Numbers 21-99 are said "reversed": eenentwintig (21 = one-and-twenty), vijfendertig (35). Time: "half negen" = 8:30 (half TO nine, not half past eight!), "kwart over acht" = 8:15, "kwart voor negen" = 8:45, "tien over half negen" = 8:40.', tr: 'Sayılar 21-99 "ters" söylenir: eenentwintig (21 = bir-ve-yirmi), vijfendertig (35). Saat: "half negen" = 8:30 (dokuza yarım — sekiz buçuk demek, dikkat!), "kwart over acht" = 8:15, "kwart voor negen" = 8:45, "tien over half negen" = 8:40.' },
      { en: 'Dates: 12 mei 2026 (day-month-year, no capital for months). Ordinals: de eerste, de tweede, de derde. Year: tweeduizend zesentwintig.', tr: 'Tarihler: 12 mei 2026 (gün-ay-yıl, ay küçük harfle). Sıra sayıları: de eerste, de tweede, de derde. Yıl: tweeduizend zesentwintig.' },
    ],
    tables: [
      {
    ...
    ex: [
      ...
      { nl: 'Ik ben geboren op drie maart.', en: 'I was born on the third of March.', tr: 'Üç Mart’ta doğdum.' },
